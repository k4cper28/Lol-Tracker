...
export const RankCard = ({ title, rankData }: RankCardProps) => {
  ...
  if(!rankData) {
    return (
      ...
      <div className="rank-card-content">
        <img src={`/ranks/unranked.png`} alt="Rank tier badge" className="game-card-rank-icon" />
  ...
  return (
    <div className="rank-card"> 
      ...
      <div className="rank-card-content">
        <img src={`/ranks/${tier.toLowerCase()}.png`} alt={`${tier} badge`} className="game-card-rank-icon" />
        
        <div className="rank-card-info">
          <span className="rank-card-info-rank">{tier} {rank}</span>
